...
async function testCloudflareR2() {
  try {
    ...
    const testContent = Buffer.from('¡Hola desde Cloudflare R2! Test: ' + new Date().toISOString());
    ...
    console.log('🎉 ¡Prueba completada exitosamente! Cloudflare R2 está funcionando correctamente.');
