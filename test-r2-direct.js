...
const secretAccessKey = '9e22c8ccf1559982db9dc233e77a0e3bc5e35a07b2ce3540ff002177fbeb5c24';
...
async function testR2Connection() {
  try {
    ...
    console.log('✅ Conexión exitosa! Objetos encontrados:', response.KeyCount || 0);
    ...
    if (response.Contents && response.Contents.length > 0) {
      ...
      console.log('📂 El bucket está vacío (esto es normal para un bucket nuevo)');
    }
    
    // Probar subir un archivo pequeño
    console.log('📤 Probando subir un archivo de prueba...');
    const testContent = Buffer.from(`Prueba de Cloudflare R2 - ${new Date().toISOString()}`);
    ...
    console.log('🔗 Tu bucket está en: https://' + bucket + '.' + accountId + '.r2.cloudflarestorage.com/');
