...
async function forceMigrationFix() {
  ...
  try {
    ...
    console.log(`Conectando a: ${connectionConfig.host}:${connectionConfig.port}/${connectionConfig.database}`);
...
forceMigrationFix()
  .then(async () => {
    ...
    try {
      ...
      console.log('⚠️ Error en migraciones de Prisma, continuando con el servidor...');
